...
import { BriefcaseBusiness, Calendar, DollarSign, Info, Lock, Mail, Pen, Phone, ToggleLeft, ToggleRight, User2 } from "lucide-react";
...
export default async function Client({ params }: ClientProps) {
  ...
  const {data: client} = await axios.get<IClient>(`http://localhost:8080/client/${id}`, {
	...
	return (
		<>
		<Card className="w-80 hidden lg:block min-h-[468px]">
